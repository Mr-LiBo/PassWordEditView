package com.libo.myPasswordView;
...
/**
 * Created by Allen on 2018/12/7.
 * 自定义支付密码输入框
 */


public class PayPsdView extends EditText {
    ...
    private int focusedColor = Color.GRAY;//获取焦点
    ...
    public PayPsdView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void getAtt(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.PayPsdView);
        maxCount = typedArray.getInt(R.styleable.PayPsdView_maxCount, maxCount);
        circleColor = typedArray.getColor(R.styleable.PayPsdView_circleColor, circleColor);
        bottomLineColor = typedArray.getColor(R.styleable.PayPsdView_bottomLineColor, bottomLineColor);
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdView_radius, radius);

        divideLineWidth = typedArray.getDimensionPixelSize(R.styleable.PayPsdView_divideLineWidth, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.PayPsdView_divideLineColor, divideLineColor);
        psdType = typedArray.getInt(R.styleable.PayPsdView_psdType, psdType);
        rectAngle = typedArray.getDimensionPixelOffset(R.styleable.PayPsdView_rectAngle, rectAngle);
        focusedColor = typedArray.getColor(R.styleable.PayPsdView_focusedColor, focusedColor);
